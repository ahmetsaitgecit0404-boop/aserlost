...
console.log('');
console.log('   hPanel -> muvekkilbilgi.com -> Dağıtımlar -> Yeniden Dağıt');
console.log('   Kaynak dosyaları: "Önceki dosyaları kullanın" seçili kalsın.');
console.log('   Ortam Değişkenleri bölümüne ekle, sonra');
console.log('   "Kaydet ve yeniden dağıt" butonuna bas.');
console.log('');
